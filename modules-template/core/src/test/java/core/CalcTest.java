...
public class CalcTest {
    ...
    // private static void checkCalc(Timetable calc, double... operands) {
    ...
    //     checkCalc(new Timetable());
    //     checkCalc(new Timetable(1.0), 1.0);
    //     checkCalc(new Timetable(3.14, 1.0), 1.0, 3.14);
    // }

    // @Test
    // public void testPushOperand() {
    //     Timetable calc = new Timetable();
    ...
    //     Timetable calc = new Timetable(1.0, 3.14);
    //     Assertions.assertEquals(3.14, calc.peekOperand());
    //     Assertions.assertThrows(IllegalArgumentException.class, () -> new Timetable().peekOperand());
    // }
    ...
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable().popOperand());
    // }

    // @Test
    // public void testPerformOperation1() {
    //     Timetable calc = new Timetable(1.0);
    ...
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable().performOperation(n -> -n));
    // }


    // @Test
    // public void testPerformOperation2() {
    //     Timetable calc = new Timetable(1.0, 3.0);
    ...
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable(1.0).performOperation((n1, n2) -> n1 - n2));
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable().performOperation((n1, n2) -> n1 - n2));
    // }
    ...
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable(1.0).swap());
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable().swap());
    // }
    ...
    //     Assertions.assertThrows(IllegalStateException.class, () -> new Timetable().dup());
    // }
}
