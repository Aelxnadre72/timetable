...
public class EventTest {
    ...
    public void constructorExceptionTest(){
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work", "work","At the office","08:00","09:30","33.11.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work", "work","At the office","08:00","09:00","13.13.2022"));
    }
