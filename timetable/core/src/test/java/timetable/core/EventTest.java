...
public class EventTest {
    ...
    public void testSetTimeStart(){
        Event event = new Event("Work","At the office","08:00","09:00","01.04.2022");
    ...
    public void constructorExceptionTest(){
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","08:00","09:00","01.04.2018"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","08:00","20004:00","01.04.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","81:81","09:00","01.04.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","08:00","1:00","01.04.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","08:00","five","01.04.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","four","20:00","01.04.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","08:00","99:00","01.04.2022"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Event("Work","At the office","08:00","09:00","1.4.18"));
    }
}
